from flask_migrate import Migrate, MigrateCommand	# in other words from flask_migrate import Migrate, MigrateCommand
...
from flask_script import Manager  # In other words from flask_script import Manager
